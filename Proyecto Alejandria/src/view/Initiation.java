...
public class Initiation extends javax.swing.JFrame implements interfaceHome{
    ...
    private void initComponents() {
        ...
        jLabel2.setText("                            Libreria de Alejandria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Initiation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Initiation().setVisible(true);
            }
        });
    }
